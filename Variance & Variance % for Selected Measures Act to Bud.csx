// Works if the measure begins with Act and the comparator starts with Bud
// Creates Var and Var % measures
// New measures in the same folder as the existing measure
